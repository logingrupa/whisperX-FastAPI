...
- [x] 14-03-PLAN.md — Zustand authStore + zod auth schemas + BroadcastChannel sync (Wave 3)
...
- [x] 15-02-logout-all-PLAN.md — POST /auth/logout-all route + integration tests (Wave 1)
...
- [x] 19-02-PLAN.md — app/core/services.py with @lru_cache(maxsize=1) singletons (Wave 1)
- [x] 19-03-PLAN.md — get_db generator + chained repo/service _v2 providers (Wave 1)
- [x] 19-04-PLAN.md — authenticated_user + authenticated_user_optional + scoped task repo Depends + Set-Cookie attr lock (Wave 2)
- [x] 19-05-PLAN.md — csrf_protected Depends factory (Wave 2)
- [x] 19-06-PLAN.md — Pilot route migration: /api/account/me + DELETE /api/account[/data] (Wave 3)
- [x] 19-07-PLAN.md — Route sweep: auth/key/billing/task/ws_ticket routers to Depends chain (Wave 4)
...
| 19. Auth + DI Structural Refactor | v1.2 | 13/17 | In Progress|  |
