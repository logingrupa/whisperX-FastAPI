...
**Plans**: 4 plans (3 waves)
- [ ] 12-01-PLAN.md — Typer dep + app/cli/ scaffold + shared _resolve_admin / _get_container helpers + AuthService.register plan_tier kwarg (Wave 1)
...
| 12. Admin CLI + Task Backfill | v1.2 | 0/4 | Not started | - |
