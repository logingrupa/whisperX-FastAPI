...
- [ ] 11-01-PLAN.md — Foundation: argon2-cffi+pyjwt deps, AuthSettings, _sha256_hex helper, RedactingFilter wired, 9 typed auth exceptions (Wave 1)
...
| 11. Auth Core Modules + Services + DI | v1.2 | 0/5   | Planned     | - |
